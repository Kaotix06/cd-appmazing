...
public class CategoryController {
    ...
    @GetMapping
    public String testController(){ return "Category controller works!";}

    @PostMapping
    public String testController(@RequestBody String name) {return "Category controller works, " + name + "!";}

    @GetMapping(value = "/testMethod")
    public String testControllerMethod(){return "Category controller method works!";}
    ...
    public int insertContact(@RequestBody CategoryDTO category){return this.categoryService.insertCategory(category);}
